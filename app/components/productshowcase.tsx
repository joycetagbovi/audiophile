      ...
      <div className="container-fluid space-y-12">
        ...
        <div className="zx9-speaker px-6 lg:pt-24 py-16  lg:px-24 rounded-[8px] flex flex-col lg:flex-row items-center justify-center text-white overflow-hidden lg:h-[560px] h-full">
          <div className="lg:w-1/2  lg:mb-0  mb-6 ">
            <img src="/assets/home/desktop/image-speaker-zx9.png" alt="zx9 speaker" className="w-[410px] h-[493px]  max-w-full hidden lg:block" />
            <img src="/assets/home/mobile/image-speaker-zx9.png" alt="zx9 speaker" className="  max-w-full md:hidden block" />
            <img src="/assets/home/tablet/image-speaker-zx9.png" alt="zx9 speaker" className="  max-w-full hidden lg:hidden md:block " />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="">
            <img src="/assets/home/desktop/image-earphones-yx1.jpg" alt="earphone"  className="rounded-[8px] w-full"/>
          </div>
